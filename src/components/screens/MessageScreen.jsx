            ...
            <div className="mx-auto relative w-full max-w-3xl flex justify-center">
                ...
                >
                    <p className="text-[#301733] text-base md:text-lg leading-relaxed overflow-y-auto max-h-[400px] pr-2">
                        Happy Birthday, My Brother You deserve all the happiness, love, and smiles in the world today and always.
                        You have this special way of making everything special in my life.
                        I hope your day is filled with laughter, surprises, and moments that
                        make your heart happy. You’re truly my best friend and I just want you to know how special you are.
